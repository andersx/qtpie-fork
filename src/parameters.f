...
!>
!! A utility function for allocating dynamic memory for vectors and matrices
!<
...
!>
!! A utility function for allocating dynamic memory for a vector of atoms
!<
